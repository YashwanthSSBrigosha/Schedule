...
public interface ApiService {
    ...
    @Headers({
            "Authorization:Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..OmvpN8ZH43PAgPHqrF4OfS3ghC1PjJbKCpQkojJaQpw","orgurl:test.theclassroom.biz"})
    @GET("/api/schedule-new/")
    Call<GetScheduleHomePageResponse> scheduleHomeCall();

    @Headers({
            "orgurl:test.theclassroom.biz",
            "Authorization:Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..OmvpN8ZH43PAgPHqrF4OfS3ghC1PjJbKCpQkojJaQpw"})
